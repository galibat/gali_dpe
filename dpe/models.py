...
class Dpe(models.Model):
    ...
    ancien_dpe_id = models.OneToOneField('self', models.DO_NOTHING, blank=True, null=True, db_column='ancien_dpe_id')
...
class DpeAdministratif(models.Model):
    dpe_id = models.OneToOneField(Dpe, models.DO_NOTHING, db_column='dpe_id', null=True, blank=True)
...
class DpeBaieVitreeDoubleFenetre(models.Model):
    baie_vitree_id = models.OneToOneField(DpeBaieVitree, models.DO_NOTHING, null=True, blank=True, db_column='baie_vitree_id', db_index=True)
...
class DpeGeolocalisation(models.Model):
    administratif = models.OneToOneField(DpeAdministratif, models.DO_NOTHING, primary_key=True, editable=True, db_column='administratif')
    ...
    adresse_bien_id = models.ForeignKey(DpeTAdresse, models.DO_NOTHING, db_column='adresse_bien_id', to_field='id', blank=True, null=True, db_index=True)
...
class DpeJson(models.Model):
    dpe_id = models.OneToOneField(Dpe, models.DO_NOTHING, primary_key=True, editable=True, db_column='dpe_id')
    ademe =  models.CharField(max_length=100, blank=True, null=True, db_index=True)
    version =  models.CharField(max_length=100, blank=True, null=True, db_index=True, default='original')
    json_content = models.TextField(blank=True, null=True, db_comment='Contenu json du DPE')

    class Meta:
        managed = True
        db_table = 'dpe_json'

class DpeAnalyse(models.Model):
...
class DpeAnomalie(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    analyse_id = models.ForeignKey(DpeAnalyse, models.DO_NOTHING, db_column='analyse_id', db_index=True,  null=True, blank=True)
    
    code = models.CharField(max_length=100, db_index=True)
    titre = models.CharField(max_length=100, blank=True, null=True)
    commentaire = models.TextField(blank=True, null=True)
    precision = models.FloatField(null=True, blank=True)
    incoherence = models.FloatField(null=True, blank=True)
    fiabilite_admin = models.FloatField(null=True, blank=True)
